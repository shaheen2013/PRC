...
Nova.booting(function (Vue, router, store) {
    Vue.component('project-details', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        loadCommunity: function loadCommunity() {
            ...
            Nova.request().get('/nova-vendor/project-details/loadCommunity/' + this.resourceId).then(function (response) {
                console.log(response);
                _this.project.loading = false;
                _this.project.data = response.data.project.data;
                _this.project.local = response.data.projLocal;
                console.log(response.data.projLocal);
            });
        },
        deleteProject: function deleteProject() {
            this.deleteProj = true;
            Nova.request().post('/nova-vendor/project-details/deleteCommunity', { projectId: this.resourceId }).then(function (response) {
                console.log(response);
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("div", { attrs: { id: "projectInfo" } }, [
      ...
      !_vm.project.loading
        ? _c("div", [
            _c("h2", { staticStyle: { color: "#0a4c9e" } }, [
              _vm._v("Project Name: " + _vm._s(_vm.project.data.name))
            ]),
            _vm._v(" "),
            _c(
              "strong",
              { staticStyle: { color: "#9c9b9b", padding: "5px 0px" } },
              [_vm._v("ID #" + _vm._s(_vm.project.data.gid))]
            ),
            _vm._v(" "),
            _c("br"),
            _vm._v(" "),
            _c("strong", { staticStyle: { color: "#9c9b9b" } }, [
              _vm._v(
                "Created At #" +
                  _vm._s(_vm.project.local.created_at.split(" ")[0])
              )
            ]),
            _vm._v(" "),
            _c("br"),
            ...
            _c("br"),
            _vm._v(" "),
            _c("h2", { staticStyle: { color: "#22292f" } }, [
              _vm._v("Project Owner: " + _vm._s(_vm.project.data.owner.name))
            ]),
            _vm._v(" "),
            _c(
              "strong",
              { staticStyle: { color: "#9c9b9b", padding: "5px 0px" } },
              [_vm._v("Owner ID #" + _vm._s(_vm.project.data.owner.gid))]
            )
          ])
        : _vm._e()
    ])
