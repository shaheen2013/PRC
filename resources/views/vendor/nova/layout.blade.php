...
<head>
    ...
    <link type="image/x-icon" rel="shortcut icon" href="https://s3.amazonaws.com/communitymanagement/ProchampsFavIcon.ico">
    <!-- Fonts -->
    ...
    <div id="nova">
        <div v-cloak class="flex min-h-screen">
            ...
            <collapsible-sidebar class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6" persist>
                <a href="{{ Nova::path() }}">
                    <div class="absolute pin-t pin-l pin-r bg-logo flex items-center w-sidebar h-header px-6 text-white" style="height: 4.5rem;">
            ...
            <!-- Content -->
            <div class="content">
                <div class="flex items-center relative shadow bg-white h-header z-20 px-6" style="height: 4.5rem;">
